...
Evidence base: `release_notes.md`, `facts.md`, `benchmark_local.md`, and `dep_audit.md`
...
- Audited project source boundaries and attribution across upstream LangGraph agent code, native Skills, MCP servers, third-party open-webSearch, and locally added portfolio documentation.
...
- Added frontend demo input controls and an explicitly labeled offline replay mode based on recorded SSE fixtures.
...
- "The router always selects a specific Skill for an input." Say that the demo observes the actual `skill_selected` event instead.
...
| Source boundaries were documented | `docs/portfolio/release_notes.md` |
